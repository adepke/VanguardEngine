...
function IncludeThirdParty()
	...
	includedirs "VanguardEngine/ThirdParty/Tracy/public"
	...
	includedirs "VanguardEngine/ThirdParty/sqlite"
end
...
function RunThirdParty()
	...
	include "VanguardEngine/ThirdParty/sqlite"
end
...
project "Engine"
	...
	filter {}
		...
		files { "VanguardEngine/Source/Scene/*.h", "VanguardEngine/Source/Scene/*.cpp" }
	...
	filter { "platforms:Win64" }
		...
		files { "VanguardEngine/Source/Scene/Windows/**.h", "VanguardEngine/Source/Scene/Windows/**.cpp" }
